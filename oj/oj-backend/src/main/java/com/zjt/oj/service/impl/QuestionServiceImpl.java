...
import com.zjt.oj.mapper.QuestionMapper;
import com.zjt.oj.model.dto.question.QuestionQueryRequest;
 ...
 * @createDate 2023-12-13 14:13:18
 */
@Service
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    /**
     * 工具方法
     * 获取查询包装类(用户根据查询字段，根据前端传来的请求对象，得到对应的QueryWrapper)
     * 查询字段：id | userid | 标题 | 内容 | 答案 | 标签
     * @param questionQueryRequest 请求问题
